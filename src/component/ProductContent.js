...
import AlarmSystem from '../assets/AlarmSystem.jpeg';
import SmartCamera from '../assets/SmartCamera.jpeg';
import LightingSystem from '../assets/LightingSystem.jpeg';
import SmartPower from '../assets/SmartPower.jpeg';
import HomeAppliance from '../assets/HomeAppliance.jpeg';
import OtherSmart from '../assets/OtherSmart.jpeg';
...
const ProductContent = props => {
  ...
  const categories = () => (
    mycategory.map(
      product =>
        <ProductBox style={featureBoxStyle} key={product.name}>
          <ProductCard imgURL={product.image} imgSize={imageSize} captionTitle={product.name} captionText={captionText} />
        </ProductBox>
    )
  )
